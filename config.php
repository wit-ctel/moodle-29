...
$CFG->dbname    = 'moodle-29';     // database name, eg moodle
$CFG->dbuser    = 'moodle-29';   // your database username
$CFG->dbpass    = 'ecqUIsih5zKB';   // your database password
...
$CFG->wwwroot   = 'http://moodle-29.example.com';
...
$CFG->dataroot  = '/Users/Cathal/Work/vle/moodle-29_data';
...
//
 $CFG->passwordsaltmain = 'F:ae-EGq#Ez4^h]#wz`vYJzoG(Uh]M^V[Y]';
//
